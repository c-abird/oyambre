        ...
        def active_scaffold_input_paperclip(column, options)
          ...
          if paperclip.file?     
            img = if paperclip.styles.include?(:thumbnail_big)
                  ...
                  image_tag('/images/inshalla/thumb_file.png')
                end
            content = link_to(img, paperclip.url)
          else
            content = image_tag('/images/inshalla/thumb_none.png')
          end
          ...
          if ActiveScaffold.js_framework == :jquery
            ...
            js_remove_file_code << "$(this).parent().prev().find('img').attr('src', '/images/inshalla/thumb_none.png');"
          ...
          remove_link = content_tag(:a, I18n.t('inshalla.remove_file'), {:href => '#', :onclick => js_remove_file_code})
